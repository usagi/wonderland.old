    ...
    public:
      ...
      virtual ~wonderland_t()
      {
        if ( _state != state_e::ending )
        {
          ...
          {
            switch(a)
            { case state_e::initializing: return "initializing";
              case state_e::running     : return "running";
              case state_e::suspending  : return "suspending";
              case state_e::ending      : return "ending";
